...
class MobileNetRefineDetLiteCBAM(nn.Module):
    def __init__(self, num_classes):
        ...
        # --- FIXED LAYERS (The "Context" Fix) ---
        # Layer 6  -> Stride 8  (40 channels)  <-- DETAIL HEAD
        # Layer 12 -> Stride 16 (112 channels) <-- CONTEXT HEAD (New)
        
        self.arm_loc_layers = nn.ModuleList([
            nn.Conv2d(40, self.num_anchors * 4, 3, padding=1),
            nn.Conv2d(112, self.num_anchors * 4, 3, padding=1), # Adjusted to 112 ch
        ])
    ...
    def forward(self, x):
        ...
        for i, layer in enumerate(self.features):
            ...
            if i == 12: sources.append(x) # Stride 16 (Replaces old Stride 32)
        ...
        # BiFPN Lite (Top-Down Merge: 16 -> 8)
